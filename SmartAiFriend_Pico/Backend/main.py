...
# def run_backend():
#     # Run uvicorn as an external process, not in reload mode inside Python
#     subprocess.Popen([
#         "uvicorn", "app:app",
#         "--host", "127.0.0.1",
#         "--port", "8000",
#         "--reload"  # safe here, because subprocess will manage reloader properly
#     ], cwd=BASE_DIR)

# def run_frontend():
#     subprocess.Popen(["cmd", "/c", "npm run dev"], cwd=FRONTEND_DIR)

# if __name__ == "__main__":
#     print("🚀 Starting Pico Assistant...")
#     run_backend()
#     time.sleep(2)
#     run_frontend()
...
def run_backend():
    # Run uvicorn as an external process
    subprocess.Popen([
        "uvicorn", "app:app",
        "--host", "127.0.0.1",
        "--port", "8000",
...
def open_browser():
    # wait for frontend to start building
    time.sleep(5)
...
if __name__ == "__main__":
    ...
    print("✅ Backend + Frontend running (Browser Opened)")
