...
class SpeechEngine:
    ...
    TTS (Edge-TTS) with pygame for playback (streaming).
    - Adds is_speaking flag for multitasking assistant.
    - Accepts state_callback(state_str) to report 'listening'/'speaking'/'idle'.
    """
    ...
    def __init__(self, state_callback: Optional[Callable[[str], None]] = None):
        ...
        # callback to notify backend/WS manager
    ...
    def listen(self) -> str | None:
        ...
        if self.state_callback:
            try:
                ...
                print(f"State callback error (listening): {e}")
        ...
        try:
            ...
            if self.state_callback:
                try:
                    ...
                    print(f"State callback error (idle after listen): {e}")
            ...
            try:
                ...
                if self.state_callback:
                    try:
                        ...
                        print(f"State callback error (speaking): {e}")
                ...
                if self.state_callback:
                    try:
                        ...
                        print(f"State callback error (idle after speak): {e}")
                try:
                    os.remove(file_path)
                except Exception:
                    pass
